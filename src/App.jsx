...
export default class App extends React.Component {
  ...
  render(){
    const dogList = [
      {name: "", breed: "Beagle", size: "small", activity: "energetic", rate: 16, img: "/images/beagle.jpg"},
      ...
      {name: "", breed: "German Shepherd", size: "large", activity: "regular", rate: 18, img: "/images/germanShepherd.jpg"},
      {name: "Baker", breed: "Golden Retriever", size: "large", activity: "high", rate: 23, img: "/images/goldenRetriever.jpg"},
      {name: "", breed: "Rottweiler", size: "large", activity: "regular", rate: 21, img: "/images/rottweiler.jpg"},
